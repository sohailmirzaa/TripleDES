...
print("")
print("")
print("1)You need to provide atleast 8 character long password for secure encryption ")
print("2)Choose a strong and non-repeating password for best security.")
#print("-----------------------------------------------------------------------------------------------------------------------------")
print("")
print("")
print("")
print("RULE #1 The files on which operations are being performed should be in same folder. ")
print("RULE #2 The encrypted and decrypted files by default are saved as encrypted_originalname.originalformat and decrypted_originalname.originalformat respectively. ")
print("")
print("NOTE:In some cases, file format error during decryption may occur if image was not encrypted using this program.")
